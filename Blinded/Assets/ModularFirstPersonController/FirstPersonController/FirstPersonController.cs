...
public class FirstPersonController : MonoBehaviour
{
    ...
    public PlayerMovementAnimation playerMovementAnimation;
    ...
    private void Awake()
    {
        ...
        if (!unlimitedSprint)
        {
            ...
            sprintCooldownReset = sprintCooldown * 4;
        }
    }
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            {
                isWalking = false;
                playerMovementAnimation.SetPlayerAnimation(PlayerMovementAnimation.TypesOfMovement.Idle);
                return;
            }
            ...
            {
                playerMovementAnimation.SetPlayerAnimation(PlayerMovementAnimation.TypesOfMovement.Run);
            ...
            {
                playerMovementAnimation.SetPlayerAnimation(PlayerMovementAnimation.TypesOfMovement.Walk);
                isSprinting = false;
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.playerMovementAnimation = (PlayerMovementAnimation)EditorGUILayout.ObjectField(
            new GUIContent("playerMovementAnimation", "playerMovementAnimation attached to the controller."), fpc.playerMovementAnimation,
            typeof(PlayerMovementAnimation), true);
